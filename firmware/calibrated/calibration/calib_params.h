...
// 2. 자력계 3-param (Task-Aware) 보정용 대수 정합 변수
const float MAG_W[3][3] = {
  {   0.00017515f,   0.00000000f,   0.00000000f },
  {   0.00000000f,   0.00017515f,   0.00000000f },
  {   0.00000000f,   0.00000000f,   0.00017515f }
};

const float MAG_B[3] = {
  -615.79068991f, 8593.13101272f, 15738.60705807f
};
