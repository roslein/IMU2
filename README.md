...
*   **Wahba SVD 기반의 복각 회피 설계 (V0.2)**:
    *   SVD align_vectors 정합 루틴을 도입해 한국 고유 복각(55도)에 따른 방위각 뒤집힘 특이점을 완전 종식하고, 가속도 1.0 대 자력계 0.02의 비대칭 가중치 구속을 적용해 지자기 잡음의 Roll/Pitch 축 오염을 원천 차단함.
