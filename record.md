...
- 9자유도 피팅의 회전 꼬임 기하학적 문제 진단, 데이터 이원화(30,000점 전체 원시 데이터 피팅 vs 20점 평균 데이터 검증), 5가지 비교군 모델(3/6/9-sym/9-full/융합형 가중 패널티 제4안) 설계, Magnitude Norm 및 Dip Angle RMSE 등의 정량 평가 지표를 정리하여 명문화함.
